...
import type { FranchiseSupportMessage } from "../api/support.service";

interface FranchiseSupportMessageThreadProps {
...
export function FranchiseSupportMessageThread({
  messages,
  onSend,
  isSending,
  disabled,
  placeholder = "Écrire une réponse…",
}: FranchiseSupportMessageThreadProps) {
