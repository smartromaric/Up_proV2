...
**Dernière sync manuelle** : 5 juin 2026 — ajout `GET /v1/admin/orders/{orderId}` (détail course admin).
...
```json
{
  ...
  "paths": {
    ...
    "/v1/admin/orders/{orderId}": {
      "get": {
        "summary": "Détail course admin (ride + timeline + dispatch)",
        "tags": [
          "10 - Admin"
        ],
        "description": "Fiche course back-office : `order.ride`, `clientName`, `clientPhone`, `driverName`, `amountXof`, `commissionXof`, `driverEarningXof`, `events[]`, `timeline`, `dispatch` (offres/candidats). Préférer cette route à la recherche dans `GET /v1/admin/orders` + live-map. Front : `tripDetail.service.ts`, `adminOrderDetail.mapper.ts`.",
        "security": [
          {
            "bearerAuth": []
          }
        ...
        "responses": {
          "200": {
            "description": "Détail course agrégé"
          },
          "401": {
            "description": "Default Response",
            "content": {
