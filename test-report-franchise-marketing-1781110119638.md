...
- **Status:** 200
- **Token:** franchise
- **Réponse:** `{"status":"ok","generatedAt":"2026-06-10T16:47:58.694Z","items":[],"pagination":{"page":1,"limit":20,"total":0,"hasMore":false}}`

### Liste campagnes
- **Endpoint:** `GET /v1/franchise/marketing/campaigns`
- **Status:** 200
- **Token:** franchise
- **Réponse:** `{"status":"ok","generatedAt":"2026-06-10T16:47:59.179Z","items":[],"pagination":{"page":1,"limit":20,"total":0,"hasMore":false}}`

### Liste bannières
- **Endpoint:** `GET /v1/franchise/marketing/banners`
- **Status:** 200
- **Token:** franchise
- **Réponse:** `{"status":"ok","generatedAt":"2026-06-10T16:47:59.479Z","items":[],"pagination":{"page":1,"limit":20,"total":0,"hasMore":false}}`
...
- **Réponse:** `{"status":"error","generatedAt":"2026-06-10T16:47:58.888Z","error":{"code":"FRANCHISE_PROMO_NOT_FOUND","message":"Promo not found"}}`
